...
public class ExcelHelper {
    ...
    static String[] HEADERs = { "Id", "Address", "Birth Date", "Email", "Gender", "Name" , "Phone", "Status", "Team" };
    ...
    public static ByteArrayInputStream usersToExcel(List<User> users) {
        ...
        try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream();) {
            ...
            for (User user : users) {
                ...
                row.createCell(2).setCellValue(user.getBirthDate());
                ...
                row.createCell(8).setCellValue(user.getTeam().getName());
            }
